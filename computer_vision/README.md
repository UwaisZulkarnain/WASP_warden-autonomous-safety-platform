...
| `last.pt`             | Model weights from the final training epoch. Mainly used for training recovery.                                   |
...
| `args.yaml`           | Training configuration automatically generated by Ultralytics containing training parameters and hyperparameters. |
