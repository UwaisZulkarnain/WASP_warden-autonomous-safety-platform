...
warnings = [
    ...
    "Amaran! Paras gas berbahaya. Sila keluar kawasan segera.",
    "Amaran! Suhu terlalu tinggi. Sila berehat dan minum air.",
    "Amaran! Kelembapan terlalu tinggi. Persekitaran tidak selamat.",
    "Amaran! Suhu tinggi dan gas berbahaya. Sila keluar segera.",
